...
module mealy_fsm_tb;
    ...
    initial begin
        ...
        #10;
        rst_n = 0;
        $monitor("Time: %0t rst_n: %b | in_bit: %b | y: %b", $time, rst_n, in_bit, y);
        #10; rst_n = 0; in_bit = 0; // Reset the FSM
        #10; rst_n = 1; in_bit = 0; // Start sequence
        #10; in_bit = 1; 
        #10; in_bit = 0;
        #10; in_bit = 1;
        ...
        #10; in_bit = 0;
        #10; in_bit = 1;
        #10; rst_n = 0;  in_bit = 1; // Reset the FSM again
        #10; rst_n = 1; in_bit = 1; // Start sequence again
        #10; in_bit = 0;
        #10; in_bit = 1;
